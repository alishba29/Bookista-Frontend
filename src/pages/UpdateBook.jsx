      ...
      const submit = async () =>{
        try{
            if(
                ...
                const response = await axios.put("https://bookista.vercel.app/api/v1/update-book",
                   Data,
                    {headers},
                );
        setData({
  ...
  return (
    ...
    <div className='p-4 bg-zinc-800 rounded'>
        <div>
            ...
            <input type="text"
            className='w-full mt-2 bg-zinc-900 tezt-zinc-100 p-2 outline-none'
        ...
        <button
        className='mt-4 px-3 bg-blue-500 text-white font-semibold py-2 rounded hover:bg-blue-600 transition-all duaration-300' 
        onClick={submit}>
            Update Book
        </button>
        </div>
